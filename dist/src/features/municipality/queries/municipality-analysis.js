...
export async function queryMunicipalityAnalysis(id) {
...
ORDER BY i.created_on DESC;
    `, [id]);
    return {
        incidentsOverTime: incidentsOverTime.rows.length === 0 ? [] : incidentsOverTime.rows,
        categoryDistribution: categoryDistribution.rows.length === 0 ? [] : categoryDistribution.rows,
